...
use crate::{
    application::dto::{
        ...
        DiplomaImportRowResult, DiplomaShareLinkResponse, DiplomaStatusResponse,
        HrRegistrySearchRequest, HrRegistrySearchResponse, LoginRequest, PublicDiplomaView,
        RegisterDiplomaRequest, RegisterDiplomaResponse, RegisterUserRequest,
        StudentDiplomaCard, StudentDiplomaSearchRequest, StudentDiplomaSearchResponse,
        UserResponse, VerifyDiplomaRequest, VerifyDiplomaResponse,
    },
    domain::{
